...
describe('authentication controller', () => {
  ...
  describe('logout', () => {
    ...
    test('should call authService.logout and return success', () => {
      // arrange
      const refreshToken = 'mock-refresh-token';
      mockRequest.cookies = { refresh_token: refreshToken };

      // act
      const result = controller.logout(mockResponse, mockRequest);
    ...
    test('should clear access_token cookie', () => {
      // arrange
      mockRequest.cookies = { refresh_token: 'mock-refresh-token' };
    ...
    test('should clear refresh_token cookie', () => {
      // arrange
      mockRequest.cookies = { refresh_token: 'mock-refresh-token' };
    ...
    test('should extract refresh_token from cookies', () => {
      // arrange
    ...
    test('should pass undefined to service when refresh_token is missing', () => {
      // arrange
      mockRequest.cookies = {};
    ...
    test('should pass undefined to service when cookies object is undefined', () => {
      // arrange
      mockRequest = {
        cookies: undefined,
      } as unknown as jest.Mocked<Request>;
    ...
    test('should pass undefined to service when refresh_token is empty string', () => {
      // arrange
    ...
    test('should clear cookies even when refresh_token is missing', () => {
      // arrange
      mockRequest.cookies = {};
    ...
    test('should clear cookies even when cookies object is undefined', () => {
      // arrange
      mockRequest = {
        cookies: undefined,
      } as unknown as jest.Mocked<Request>;
